...
template<typename T>
int Bag<T>::TreeElement::balanceFactor()
{
...
template<typename T>
void Bag<T>::TreeElement::updateHeight()
{
    int heightLeft = -1;
    if (left != nullptr)
...
template<typename T>
void Bag<T>::TreeElement::printElement()
{
    cout << "(" << value << " ";
    if (left == nullptr)
        cout << "null";
...
template<typename T>
void Bag<T>::TreeElement::descendingPrint()
{
    if (right != nullptr)
...
template<typename T>
void Bag<T>::TreeElement::ascendingPrint()
{
    if (left != nullptr)
        left->ascendingPrint();
...
template<typename T>
void Bag<T>::addElement(TreeElement* &current, const T &value)
{
...
template<typename T>
void Bag<T>::deleteElement(TreeElement* &element)
{
...
template<typename T>
void Bag<T>::deleteElementInSubtree(TreeElement* &current, const T &value)
{
    if (current->value > value)
    {
...
template<typename T>
void Bag<T>::deleteTree(TreeElement* &element)
{
    if (element != nullptr)
    {
...
template<typename T>
T &Bag<T>::leftmostChild(TreeElement* &element)
{
